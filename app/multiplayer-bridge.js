...
(function(g){'use strict';
  ...
  function continueAfterAuth(after){if(after==='join')return roomCodeUI();if(after==='ranked')return rankedUI();return createRoomUI()}
