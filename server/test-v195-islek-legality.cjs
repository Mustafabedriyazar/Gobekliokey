...
T('v195 damga index',html.indexOf('gobek17-200-cift-2x1-gosterge-kanon')>=0);
...
T('v195 damga server',srv.indexOf('gobek17-200-cift-2x1-gosterge-kanon')>=0);
T('eski v194 damga kalkti (server)',srv.indexOf('gobek17-194-islek-ui-kanon')<0);
const sw=fs.readFileSync(path.join(root,'sw.js'),'utf8');
T('v195 damga sw cache',sw.indexOf('gobek17-200-cift-2x1-gosterge-kanon')>=0);
