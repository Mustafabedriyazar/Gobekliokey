...
const canonical=[
  ...
  'test-v179-targeted.cjs','test-v180-pb-rules.cjs','test-v181-fps60.cjs','test-v182-product-menus.cjs','test-v192-canon.cjs','test-v192b-okey-replacement.cjs','test-v192c-ui-drop-routing.cjs','test-v192e-uid-return.cjs','core-regression.cjs','stress-authority.cjs'
];
