...
const canonical=[
  ...
  'test-v179-targeted.cjs','test-v180-pb-rules.cjs','test-v181-fps60.cjs','test-v182-product-menus.cjs','core-regression.cjs','stress-authority.cjs'
];
const required=new Set(['packaging-guard.cjs','test-v179-targeted.cjs','test-v180-pb-rules.cjs','test-v181-fps60.cjs','test-v182-product-menus.cjs','core-regression.cjs','stress-authority.cjs']);
let ran=0,skipped=[];
